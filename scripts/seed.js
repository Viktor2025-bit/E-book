...
const seedProducts = [
  {
    ...
    price: 18.00,
    imageUrl: '/cdn/shop/files/10_307a27ee-36dd-48cf-b0df-11b80f223bab_533x781f.png',
    category: 'Business',
    format: 'PDF + EPUB',
    pages: 214,
  },
  {
    ...
    price: 22.50,
    imageUrl: '/cdn/shop/files/11_274c14d0-5fba-4d48-ab54-21692dc66b06_533x6d45.png',
    category: 'Technology',
    format: 'PDF',
    pages: 268,
  },
  {
    ...
    price: 12.99,
    imageUrl: '/cdn/shop/files/10_4bcb4218-9cbe-4906-8ec0-19a4f21f297f_533x59b5.png',
    category: 'Self-Help',
    format: 'PDF Workbook',
    pages: 146,
  },
  {
    ...
    price: 16.75,
    imageUrl: '/cdn/shop/files/12_a3b37a3f-6070-41bd-99f0-d5f8aa8f595c_533x2a25.png',
  ...
  },
  {
    ...
    price: 14.50,
    imageUrl: '/cdn/shop/files/7_2a4e4ca6-75f2-4f97-b6d1-3bb5f47c0995_533x1999.png',
    category: 'Fiction',
    format: 'PDF + EPUB',
    pages: 302,
  },
  {
    ...
    price: 11.00,
    imageUrl: '/cdn/shop/files/4_3e90e59c-bb34-40aa-823b-00526405e07a_533xcf94.png',
    category: 'Academic',
    format: 'PDF',
    pages: 128,
  },
  ...
  },
  {
    ...
    price: 13.25,
    imageUrl: '/cdn/shop/files/13_a85f7b16-7bf4-44a1-aca8-55250190dc6b_533x57e5.png',
    category: 'Business',
    format: 'PDF',
    pages: 172,
  },
  {
    ...
    price: 19.00,
    imageUrl: '/cdn/shop/files/16_c15dd6de-427a-4f22-8fee-21073d859414_533x52f7.png',
    category: 'Technology',
    format: 'PDF + EPUB',
    pages: 196,
  },
  {
    ...
    price: 8.99,
    imageUrl: '/cdn/shop/files/8_71a4989a-2d22-42e6-835b-f78f6c050914_533xfa6d.png',
    category: 'Self-Help',
    format: 'PDF',
    pages: 92,
  },
  {
    ...
    price: 15.00,
    imageUrl: '/cdn/shop/files/6_b5abd768-1935-4a75-925e-99d8eef92612_533x2f36.png',
    category: 'African Literature',
    format: 'EPUB',
    pages: 256,
  },
  {
    ...
    price: 10.50,
    imageUrl: '/cdn/shop/files/5_722c19f7-0abb-4a77-b04a-970d0b813524_533x947c.png',
    category: 'Academic',
    format: 'PDF Workbook',
    pages: 118,
  },
